...
# Create a greeting message by combining the strings "Hello".

# Combine the strings "I love" and "Python" to form a sentence.


#! Type Casting:
# Declare a variable num_str with a numeric string "42".

# Convert num_str to an integer and store it in a variable.

# Convert the last integer 42 to a float and store it in another variable.


#! Arithmetic and Type casting:
# Perform the following operations and print the results:

# Add an integer and a float values
